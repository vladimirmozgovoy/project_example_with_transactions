                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
                                        <b>Запрос на восстановление пароля!</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        Вы получили это письмо, потому что отправили запрос на восстановление пароля.
                                        <br/>
                                ...
                                <tr>
                                    <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        ...
                                        <br/>
                                        <a href="{{ config('app.frontend_url') }}/recovery/new-password?token={{ $data['token'] }}">Восстановить пароль</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
